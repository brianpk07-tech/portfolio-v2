...
export const metadata: Metadata = {
  title: "Brian Parkansky - Étudiant en ingénierie et stratégie marketing",
  ...
  authors: [{ name: "Brian Parkansky" }],
  creator: "Brian Parkansky",
  publisher: "Brian Parkansky",
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://ibiimemon.com",
    title: "Brian Parkansky - Software Engineer & UI/UX Designer",
    ...
    siteName: "Brian Parkansky Portfolio",
  },
  twitter: {
